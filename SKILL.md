...
description: "Safe phase-based OpenClaw PR workflow: scout, ownership gate, inspect, patch, proof, PR body, publish, and read-only upstream PR review."
license: MIT
---
...
- Phase 13 / UPSTREAM-PR-REVIEW is read-only review of external or official OpenClaw PRs. No patch, no test server, no GitHub write.
