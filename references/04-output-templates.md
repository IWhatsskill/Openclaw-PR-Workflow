...
- Patch, proof execution, publish actions, SSH/test-server work, and GitHub write still require exact GO.
...
Not done:
- patch/tests/build/GitHub write/reset/clean/pull
Next GO:
Recommended:
...
Proof type: source only | diagnostic runtime | live transport
Tests/Proof:
Real behavior proof:
